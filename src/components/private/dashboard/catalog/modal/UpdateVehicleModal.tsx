...
import { getVehicleById } from "@/src/actions";
...
export const UpdateVehicleModal = ({ open, setOpen, id }: Props) => {
  ...
  const { brandsData, specificationsData, setCheckedSpecs } = useCatalog();
