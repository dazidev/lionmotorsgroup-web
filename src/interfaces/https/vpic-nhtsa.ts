...
export interface VpicDecodeVinValuesResponse {
  Count: number;
  Message: string;
...
// 2) Resultado (Results[0]) — MAPEO ABSOLUTO de todas las propiedades del payload
export interface VpicDecodeVinValuesResult {
  ABS: string;
